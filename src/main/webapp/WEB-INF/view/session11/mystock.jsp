...
<html>
	...
	<body style="padding: 15px">
		<spform:form class="pure-form" method="post" modelAttribute="myStock" action="${pageContext.request.contextPath }/mvc/mystock/">
			<fieldset>
				<legend>MyStock</legend>
		...
		<table class="pure-table pure-table-bordered">
			...
			<thead>
				<tr>
					<th>股票代號</th><th>股票價格</th><th>股票股數</th>
				</tr>
			</thead>
			
			<tbody>
				<c:forEach var="myStock" items="${myStocks}">
					<tr>
